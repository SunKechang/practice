...
public class MallBrowseServiceImpl implements MallBrowseService {
    ...
    public List<MallIndexConfigGoodsVO> getRecommendGoodsByUserId(Long userId) {
        ...
        List<MallIndexConfigGoodsVO> res = new ArrayList<>(selfCommentNum);
        int used = 0;
        for(Long key : cates.keySet()) {
            ...
            List<MallIndexConfigGoodsVO> goodsTemp;
            goodsTemp = BeanUtil.copyList(listResult.getData(), MallIndexConfigGoodsVO.class);
