...
import ltd.goods.cloud.newbee.controller.vo.MallGoodsDetailVO;
...
public class MallGoodsController {
    ...
    public Result<MallGoodsDetailVO> goodsDetail(@ApiParam(value = "商品id") @PathVariable("goodsId") Long goodsId, @TokenToMallUser MallUserToken loginMallUserToken) {
        ...
        mallGoodsService.insertBrowse(loginMallUserToken.getUserId(), goods.getGoodsCategoryId());
    ...
    public Result listNewGoods(@RequestParam("num") Integer num) {
        List<Good> goods = mallGoodsService.listNewGoods(num);
    ...
    public Result listSingleCateGoods(@RequestParam("category") Long category,
        ...
        List<Good> goods = mallGoodsService.listSingleCateGoods(category, num);
        return ResultGenerator.genSuccessResult(goods);
    }
